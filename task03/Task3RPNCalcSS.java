...
public class Task3RPNCalcSS {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
	        ...
	        try (Scanner scanner = new Scanner(text)) {
                ...
                System.out.print("O resultado é: " + stack.pop());
    ...
    public static int hm (Map<String,String> hT, String key) throws Exception {
    	 if (hT.containsKey(key)) {
    		 ...
    		 throw new Exception(key + "Caractere inesperado");
    	 }
    }
    ...
    public static int algorithm(String op, String l, String r, Map<String,String> hT) throws Exception {
        ...
        case "/": {
        	...
        	value = value_l / value_r;
        	if (value_r == 0) {
        		throw new Exception("Escolha um divisor diferente de 0");
        	}
            break;
        }
        default:
